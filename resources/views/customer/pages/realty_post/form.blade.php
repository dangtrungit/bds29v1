            ...
            <div class="row">
                <div class="col-md-12">
                    <input id="title" type="text" name="title" class="form-control" placeholder="Nhập tiêu đề"
                        value="{{$realty_post->title ?? old('title')}}">
                    @error('title')
        ...
        <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="bl-radio col-md-6">
                    <input
                        data-realty-type="{{implode(',', config('constant.realty_post_type.'.$index.'.realty_type_list'))}}"
                        type="radio" name="realty_post_type" id="listingType-{{$index}}" value="{{$index}}"
                        class="listingType" @isset($realty_post) @if ($realty_post->type == $index)
                    checked
                    @endif
                    @else
                    @if ($index == 1)
        ...
        <div class="form-group">
            ...
            <div>
                <select name="realty_type" class="form-control">
                    ...
                    <option @isset($realty_post) @if ($realty->type == $index)
                        selected
                        @endif
                        @else
                        @if ($index == 1)
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-4 mb-3 mb-md-0">
                    ...
                    <input id="number_of_floors" type="number" name="number_of_floors" class="form-control"
                        placeholder="Số tầng" value="{{$realty->number_of_floors ?? old('number_of_floors')}}">
                ...
                <div class="col-md-4 has-errors mb-3 mb-md-0">
                    ...
                    <input id="number_of_bath_rooms" type="number" name="number_of_bath_rooms" class="form-control"
                        placeholder="Phòng tắm"
                        value="{{$realty->number_of_bath_rooms ?? old('number_of_bath_rooms')}}">
                    @error('number_of_floors')
                    <div class="text-danger">
                        {{$message}}
                    </div>
                ...
                <div class="col-md-4 mb-3 mb-md-0">
                    <div class="form-group">
                        ...
                        <input type="number" name="number_of_bed_rooms" id="" class="form-control"
                            placeholder="Phòng ngủ" aria-describedby=""
                            value="{{$realty->number_of_bed_rooms ?? old('number_of_bed_rooms')}}">
                    </div>
                ...
                <div class="col-md-4 mb-3 mb-md-0">
                    <select class="form-control" id="furniture" name="furniture">
                        <option value="">Nội thất</option>
                        <option value="0" name="option-noi-that">Cơ bản</option>
                        <option value="1" name="option-noi-that">Nguyên bản</option>
                        <option value="2" name="option-noi-that">Full đồ</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-6 col-sm-4 price-fav mb-3 mb-md-0">
                    ...
                    <input id="price" type="number" name="price" class="form-control" placeholder="Giá đề nghị"
                        value="{{$realty_post->price ?? old('price')}}" onkeyup="onChangeInput(event);">
                    @error('price')
                    <div class="text-danger">
                        {{$message}}
                    </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 mb-3 mb-md-0">
                    <select class="form-control address_input" id="province" name="province">
                        ...
                        <option @if($province_code==$item->code) selected @endif value="{{$item->code}}">{{$item->name}}
                        </option>
                        @endforeach
                    </select>
                    @error('province')
                ...
                <div class="col-md-4 col-sm-4 select-district-fav mb-3 mb-md-0">
                    <select class="form-control address_input" id="district" name="district">
                        ...
                        <option @if ($district->code == $realty->district_code) selected @endif
                ...
                <div class="col-md-4 col-sm-4 select-ward-fav mb-3 mb-md-0">
                    <select class="form-control address_input" id="commune" name="commune">
                        ...
                        <option @if ($commune->code == $realty->commune_code) selected @endif
            ...
            <div class="row">
                <div class="col-md-8 col-sm-12 select-ward-fav">
                    <select class="form-control address_input" id="project" name="project[]" multiple="multiple">
                        ...
                        <option @if ($project->id == $realty->project_id) selected @endif
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-4 mb-3 mb-md-0">
                    <input name="apartment_number" value="{{$realty->apartment_number ?? ''}}" id="apartment-number"
                        class="form-control" type="text" placeholder="Số nhà">
                </div>
                <div class="col-sm-8 mb-3 mb-md-0">
                    <input name="street" value="{{$realty->street ?? old('street')}}" id="street"
                        class="form-control address_input" type="text" placeholder="Địa chỉ cụ thể" autocomplete="off">
                    @error('street')
                    <div class="text-danger">
                        {{$message}}
                    </div>
...
<div class="row col-upload">
    ...
    <div class="col-12">
        <div class="form-group">
            <label class="control-label">
                <span class="text">Hình ảnh nhà</span> (upload tối thiểu 2 hình, kéo thả file hoặc chọn trực tiếp từ máy
                tính , Dung lượng từ 600kb - &gt;1Mb kích thước tối thiểu đối với ảnh ngang 1714x968, ảnh đứng 968x1714)
    ...
    <div class="col-12">
        <div class="form-group">
            <label class="control-label">
                <span class="text">Bản vẽ / Sổ </span> (upload tối thiểu 4 hình, kéo thả file hoặc chọn trực tiếp từ máy
                tính, Dung lượng từ 600kb -> 1Mb kích thước tối thiểu đối với ảnh ngang 1714x968, ảnh đứng 968x1714)
                <strong class="text-danger">*</strong>
            </label>
            @include('components.dropzone_upload', [
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="hidden-feedback-icon">
            <textarea name="description" id="description" class="form-control text-description" placeholder=""
                rows="4">{{$realty_post->description ?? old('description')}}</textarea>
        </div>
        @error('description')
        <div class="text-danger">
            {{$message}}
        ...
        <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-4 ">
                    <input id="contact_phone_number" type="text" name="contact_phone_number" class="form-control"
                        placeholder="Số điện thoại"
                        value="{{$realty_post->contact_phone_number ?? old('contact_phone_number') ?? auth()->user()->phone_number ?? ''}}">
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-4 col-sm-4">
                    ...
                    @endphp
                    <select class="form-control" id="realty_post_rank" name="realty_post_rank" @isset($realty_post)
                        disabled @endisset>
                ...
                <div class="col-md-4 ">
                    ...
                    <input id="open_at" class="date-picker form-control" type="text" name="open_at" @isset($realty_post)
                        disabled @endisset @isset($realty_post->open_at)
                ...
                <div class="col-md-4 ">
                    ...
                    <input id="close_at" class="date-picker form-control" type="text" name="close_at"
                        @isset($realty_post) disabled @endisset @isset($realty_post->open_at)
    ...
    <div class="col-md-12">
        <div class="form-group">
            <div class="bl-checkbox bl-checkbox-special">
                ...
                <span id="require-post-text"> Tôi đồng ý với <a href="javascript:;" data-toggle="modal"
                        data-target="#popup-require-post"> điều khoản sử dụng</a> và <span id="price-button"><a
                            href="javasript:;" data-toggle="modal" data-target="#popup-require-price-buy">biểu phí giao
                            dịch</a></span> </span>
            </div>
        </div>
