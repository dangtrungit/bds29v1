<?php
return [
    'province_name' => env('APP_PROVINCE', 'Hà Nội'),
    'price_type' => [
        '0' => [
    ...
    'provinces' => explode(',', env('PROVINCE_ID', "1")),
    'realty_post_type' => [
        '1' => [
            'name' => 'Bán',
            'slug' => 'ban',
            ...
            // 'price_range' => [0, 7, 10, 15, 20, 30], //Đơn giá thue x1000.000
            // 'price_range_thue' => [0, 7, 10, 15, 20, 30], //Đơn giá thue x1000.000
            // 'price_range_ban' => [0, 50, 80, 100, 200, 300, 500, 700, 1000, 2000, 3000], //Gia ban x1000.000
            // 'price_range' => [0, 7000000, 10000000, 15000000, 20000000, 30000000], //Đơn giá thue x1000.000
